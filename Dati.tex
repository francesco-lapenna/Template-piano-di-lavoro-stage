...
\newcommand{\dataApprovazione}{10 Gennaio 1492}
...
\newcommand{\obiettiviDesiderabili}{
    \item \underline{\textit{D01}}: Ottimizzare le prestazioni del modulo di autenticazione per garantire compatibilità e prestazioni ottimali.
    \item \underline{\textit{D02}}: Implementare funzionalità aggiuntive per migliorare la sicurezza e la robustezza del sistema.
    \item \underline{\textit{D03}}: Analizzare i risultati dei test per identificare e risolvere eventuali criticità.
}

\newcommand{\obiettiviFacoltativi}{
    \item \underline{\textit{F01}}: Approfondire ulteriori aspetti legati all'ottimizzazione delle prestazioni del modulo.
    \item \underline{\textit{F02}}: Integrare nuove funzionalità innovative per estendere le capacità del sistema.
    \item \underline{\textit{F03}}: Esplorare possibili sviluppi futuri del progetto, come l'integrazione con altre tecnologie di comunicazione.
}